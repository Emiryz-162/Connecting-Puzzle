...
export class StartScreen {
    constructor(onStart, onOpenSettings, onSelectLevel, onOpenTutorial, onUiClick) {
        this.levelButtons = [];
        ...
        this.albumViewerPointers = new Map();
        ...
        this.handleSectionsCloseClick = () => {
            this.onUiClick?.();
            this.closeSections();
        };
        this.handleSectionsBackdropClick = (event) => {
            if (event.target === this.sectionsOverlay) {
                this.onUiClick?.();
                this.closeSections();
            }
        };
        this.handleAlbumCloseClick = () => {
            this.onUiClick?.();
            this.closeAlbum();
        };
        this.handleAlbumBackdropClick = (event) => {
            if (event.target === this.albumOverlay) {
                this.onUiClick?.();
                this.closeAlbum();
            }
        };
        this.handleAlbumViewerCloseClick = () => {
            this.onUiClick?.();
            this.closeAlbumViewer();
        };
        this.handleAlbumViewerBackdropClick = (event) => {
            if (event.target === this.albumViewerOverlay) {
                this.onUiClick?.();
                this.closeAlbumViewer();
            }
        };
        this.handleAlbumViewerZoomOutClick = () => {
            this.updateAlbumViewerScale(this.albumViewerScale - 0.3);
        };
        this.handleAlbumViewerZoomResetClick = () => {
            this.albumViewerScale = 1;
            this.albumViewerOffsetX = 0;
            this.albumViewerOffsetY = 0;
            this.applyAlbumViewerTransform();
        };
        this.handleAlbumViewerZoomInClick = () => {
            this.updateAlbumViewerScale(this.albumViewerScale + 0.3);
        };
        this.handleAlbumViewerWheel = (event) => {
        ...
        this.handleAlbumViewerPointerDown = (event) => {
            if (!this.albumViewerOpen) {
                return;
            }
        ...
        this.handleAlbumViewerPointerMove = (event) => {
        ...
        this.handleAlbumViewerPointerUp = (event) => {
        ...
        this.sectionsButton.append(this.createMenuImageIcon("/assets/icons/levels-clean.png"), this.createButtonLabel("LEVELS"));
        ...
        this.albumButton.append(this.createMenuImageIcon("/assets/icons/album-clean.png"), this.createButtonLabel("ALBUM"));
        ...
        this.tutorialButton.append(this.createMenuImageIcon("/assets/icons/education-clean.png"), this.createButtonLabel("TUTORIAL"));
        ...
        this.settingsButton.append(this.createMenuImageIcon("/assets/icons/settings-clean.png"), this.createButtonLabel("SETTINGS"));
        ...
        albumViewerControls.append(this.albumViewerZoomOutButton, this.albumViewerZoomResetButton, this.albumViewerZoomInButton, albumViewerHint);
        ...
        this.root.append(this.content, this.nowPlayingCard, this.sectionsOverlay, this.albumOverlay, this.albumViewerOverlay);
    ...
    renderSections() {
        ...
        for (let i = 0; i < this.levelButtons.length; i++) {
            ...
            const numberNode = button.firstElementChild;
            const stateNode = button.lastElementChild;
    ...
    updateAlbumViewerScale(nextScale, focusX = 0, focusY = 0) {
    ...
    getViewerFocusFromClientPoint(clientX, clientY) {
        const rect = this.albumViewerImageWrap.getBoundingClientRect();
        return {
    ...
    createMusicIcon() {
        ...
        path.setAttribute("d", "M15 2v10.8a3.2 3.2 0 1 1-2-2.95V4.9l9-2.4V11a3.2 3.2 0 1 1-2-2.95V4.2L15 5.53Z");
    ...
    createCloseIcon() {
        ...
        const path = document.createElementNS("http://www.w3.org/2000/svg", "path");
        path.setAttribute("d", "M6.7 5.3L12 10.6l5.3-5.3 1.4 1.4L13.4 12l5.3 5.3-1.4 1.4L12 13.4l-5.3 5.3-1.4-1.4L10.6 12 5.3 6.7z");
        path.setAttribute("fill", "currentColor");
        svg.appendChild(path);
        return svg;
    }
    createLockIcon() {
        ...
        svg.setAttribute("viewBox", "0 0 24 24");
        const path = document.createElementNS("http://www.w3.org/2000/svg", "path");
        path.setAttribute("d", "M7 10V8a5 5 0 1 1 10 0v2h.5A1.5 1.5 0 0 1 19 11.5v8a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 5 19.5v-8A1.5 1.5 0 0 1 6.5 10H7zm2 0h6V8a3 3 0 1 0-6 0v2zm3 4a1.5 1.5 0 0 1 1.5 1.5c0 .58-.33 1.1-.83 1.35V18a.67.67 0 0 1-1.34 0v-1.15A1.5 1.5 0 0 1 12 14z");
        path.setAttribute("fill", "currentColor");
        svg.appendChild(path);
        return svg;
    }
    createBaseIcon(width, height) {
