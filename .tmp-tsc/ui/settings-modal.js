...
export class SettingsModal {
    constructor(initialSettings, onSettingsChange, onOpenChange, onToggleInteraction, onPrimaryButtonClick) {
        ...
        this.handleButtonPressDown = () => {
            this.button.style.transform = "scale(0.96)";
        };
        this.handleButtonPressUp = () => {
        ...
        applyStyles(this.backdrop, {
            ...
            background: "radial-gradient(circle at 20% 12%, rgba(245, 159, 149, 0.24), transparent 42%), rgba(72, 46, 40, 0.52)",
    ...
    applyResponsiveStyles() {
        ...
        applyStyles(this.panel, {
            ...
            background: "linear-gradient(180deg, rgba(253, 228, 203, 0.98), rgba(251, 203, 183, 0.98))",
    ...
    applyToggleVisualState(key, checked) {
