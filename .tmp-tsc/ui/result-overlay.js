...
export class ResultOverlay {
    constructor() {
        ...
        applyStyles(this.root, {
            ...
            background: "radial-gradient(circle at 24% 12%, rgba(245, 159, 149, 0.22), transparent 42%), rgba(84, 52, 45, 0.54)",
        ...
        this.card.append(this.title, this.subtitle, this.scoreText, this.xpGainText, this.xpTrack, this.xpDetail, this.unlockedPhotoWrap, this.actionText);
...
//# sourceMappingURL=result-overlay.js.map